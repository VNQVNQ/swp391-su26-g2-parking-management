      ...
      <div className="app-layout">
        ...
        <main className={`main-content ${sidebarCollapsed ? 'collapsed' : ''}`}>
          <Routes>
            ...
            <Route path="/driver/register-ticket" element={<RoleRoute allowedRoles={['DRIVER']}><RegisterTicket /></RoleRoute>} />
            <Route path="/driver/my-tickets"      element={<RoleRoute allowedRoles={['DRIVER']}><MyTickets /></RoleRoute>} />
